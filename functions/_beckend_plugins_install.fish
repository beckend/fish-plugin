function _beckend_plugins_install
    ...
    set -l PLUGINS_TO_INSTALL IlanCosman/tide kfkonrad/last-working-dir-fish-pkg 'PatrickF1/fzf.fish' tomyun/base16-fish franciscolourenco/done gazorby/fish-abbreviation-tips
